...
const About = () => {
  return (
    <div
      id="About"
      className="text-black md:flex overflow-hidden items-center md:flex-wrap md:justify-center bg-black shadow-xl mx-0 md:mx-20 bg-opacity-30 rounded-lg p-12"
    >
      <div>
          ...
          <ul>
            <div className="flex gap-5 py-4">
              ...
              <span className="w-96">
                ...
                <p className="text-sm md:text-md leading-tight gap-8">
